 ...
 const results = {
                   rock:{ //matthew's move
                        rock: "draw", 
                        paper: "obi", //obi picks paper so he wins
                        scissors: "matthew" //obi picks scissor obi lose and Matthew wins
                        },
                    paper:{ //matthew's move
                        rock: "matthew", 
                        paper: "draw", 
                        scissors: "obi"
                        },
                    scissors:{ //matthew's move
                        rock: "obi", 
                        paper: "matthew", 
                        scissors: "draw"
                    }
 ...
 function determineWinner(matthewMove, obiMove) {
   return results[matthewMove][obiMove]; // Retrieve result directly using bracket notation
 }
